...
class OrderUpdate(LoggedUserCheckMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            ...
            qset = self.object.order_items.select_related('product')
            formset = OrderFormSet(instance=self.object, queryset=qset)
...
def proceeding_status(request, pk):
